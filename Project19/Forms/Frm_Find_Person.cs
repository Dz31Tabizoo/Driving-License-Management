...
namespace Project19
{
    public partial class Frm_Find_Person : KryptonForm
    {
        ...
        private void btnExit_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult res = MessageBox.Show("Please Select a Persone or Add a new one if not exist", "Person Select", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
